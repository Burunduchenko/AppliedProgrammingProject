...
user = User(id = 1, name = "batman23", surname = "Peter", username="Parker", password = "12345678")
user1 = User(id = 2, name = "superman23", surname = "Peter", username="Parker", password = "12345678")
audience = Audience(id = 1, number = 5432, amount_of_places = 6, status= 1, reservuation_date= '2021-10-21')
audience1 = Audience(id = 2, number = 5432, amount_of_places = 6, status= 1, reservuation_date= '2021-09-21')
